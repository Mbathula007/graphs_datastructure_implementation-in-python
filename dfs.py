...
y = graph("undershorts",{},None)
y.insert("pants","undershorts")
y.insert("belt","pants")
y.insert("jacket","belt")
y.insert(None,"shirt")
y.insert("shoes","undershorts")
y.insert("socks","shoes")
y.insert("belt","shirt")
y.insert("tie","shirt")
y.insert("jacket","tie")
y.insert(None,"watch")
print(y.topological_sort())
print(y.vertices)
